...
<body>
    ...
    <div class="row">
        <img src="/katalog.png" class="col-sm">
    ...
    <div class="container" style="height: 150rem;">
        <div class="row">
            <div class="row m-3">
                            ...
                            <div class="my-0 mx-0">
                                ...
                                <div class="row mx-0 mb-2">
                                    ...
                                    <div class="col-6 bg-primary">
                                        <a class="btn my-2 text-center text-light fs-6" href={{ route('posts.create') }}>Rent now</a>
                                    </div>
                                </div>
                            </div>
                        </div>
