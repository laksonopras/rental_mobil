<nav class="navbar navbar-expand-lg navbar-light bg-info">
    <div class="container">
        <a class="nav-link active" href="/">
            <img src="{{ url('asset/MalangDrift.png') }}" style="width: 200px;">
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto me-5 mb-lg-0">
                @auth
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" style="--bs-btn-padding-y: .25rem; --bs-btn-padding-x: .5rem; --bs-btn-font-size: .75rem; --bs-btn-width: .75rem;" href="">Your Order</a>
                    </li>
                @endauth
                <li class="nav-item  d-flex align-items-center" >
                    ...
                    <div class="dropdown ms-5">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item" href="/edit">{{ Auth::user()->username }}</a></li>
